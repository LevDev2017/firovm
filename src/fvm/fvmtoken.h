...
public:
    ...
    void setFvmTokenExec(FvmTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strFvmAddress, std::string& strHash160);
    static bool ToFvmAddress(const std::string& strHash160, std::string& strFvmAddress);
...
private:
    ...
    FvmToken(FvmToken const&);
    FvmToken& operator=(FvmToken const&);
